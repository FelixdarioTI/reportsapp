...
import { LogOut, Menu, Search, User, UserCog, UserX } from 'lucide-react';
                    ...
                    <div className="overflow-x-auto">
                      ...
                      <thead className="bg-gray-700 text-gray-300 rounded-t-lg">
                        <tr className="font-semibold text-[0.95rem]">
                          <th className="px-4 py-3 text-center min-w-fit rounded-l-lg">Data de Cancelamento</th>
                            ...
                            <tr key={plano.idf_PlanoMotivoCancelamento} className="border-b border-dashed last:border-b-0">
                              <td className="p-3 pl-0">
                                <div className="flex items-center">
                                  ...
                                  {plano.dta_Cancelamento ? new Date(plano.dta_Cancelamento).toLocaleDateString('pt-BR') : "N/A"}
                                </span>
                                  </div>
                                </div>
                              </td>
                              <td className="p-3 pr-0 text-center">
                                <span className="font-semibold text-light-inverse text-md/normal">{plano.protocolo || "N/A"}</span>
                              </td>
                              <td className="p-3 pr-0 text-center">
                                <span className="text-center align-baseline inline-flex px-2 py-1 mr-auto items-center font-semibold text-base/none text-success bg-success-light rounded-lg">
                                  {origemMotivoCancelamentoMap[plano.idf_OrigemMotivoCancelamento] || "N/A"}
                                </span>
                              </td>
